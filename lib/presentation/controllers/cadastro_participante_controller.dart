...
class CadastroParticipanteController extends GetxController {
  ...
  void createParticipante() async {
    ...
    if (newParticipanteId != null) {
      ...
      // You'll need to fetch the current avaliador's ID. For now, I'm using a placeholder value.
      int currentAvaliadorId = 1; // Replace this with the actual avaliador's ID.

      AvaliacaoEntity novaAvaliacao = AvaliacaoEntity(
        avaliacaoID: null, // This will be auto-generated by the database.
        avaliadorID: currentAvaliadorId,
        participanteID: newParticipanteId,
        atividades: [], // Convert the selected atividades from the form to a list of AtividadeEntity.
      );
